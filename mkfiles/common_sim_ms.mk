...
#* common_sim_ms.mk
#*
#* Build and run definitions and rules for Modelsim
#*
#*
#* +tool.modelsim.uvm - enable UVM with Modelsim
#* +tool.modelsim.valgrind - enable Valgrind
#****************************************************************************
...
ifeq (true,$(HAVE_UVM))
	...
	VLOG_FLAGS += +define+UVM_OBJECT_DO_NOT_NEED_CONSTRUCTOR 
endif
...
VLOG_COMPILE_DEPS += $(DPI_OBJS_LIBS)
ifeq (true,$(HAVE_UVM)) 
VLOG_COMPILE_DEPS += vlog_compile_uvm
endif
...
vlog_compile_uvm :
	$(Q)if test ! -d work; then \
		vlib work; \
		vmap work $(BUILD_DIR_A)/work; \
		fi
...
vlog_compile : $(VLOG_COMPILE_DEPS)
	...
	$(Q)vlog $(SIMSCRIPTS_MKFILES_DIR)/dummy_dpi.c
	$(Q)vlog -sv \
		$(VLOG_FLAGS) \
		$(QS_VLOG_ARGS) \
